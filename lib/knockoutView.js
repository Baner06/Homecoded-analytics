...
export const BRACKET_LEFT = {
  // Pares 32vos → 16vos: (73,75→90), (74,77→89), (81,82→94), (83,84→93)
  'round-of-32': [73, 75, 74, 77, 81, 82, 83, 84],
  'round-of-16': [90, 89, 94, 93],
...
export const BRACKET_RIGHT = {
  // Pares 32vos → 16vos: (76,78→91), (79,80→92), (86,88→95), (85,87→96)
