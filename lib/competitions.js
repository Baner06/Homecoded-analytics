...
export const COUNTRIES = [
  ...
  // "Países" pseudo, uno por confederación, solo para agrupar sus torneos de
  // clubes en el árbol del catálogo (que es continente -> país -> competición).
  // iso: null porque no representan un país real; flagEmoji reemplaza la
  // bandera en el menú (ver assets/js/leagues.js).
  { code: 'uefa-clubs', continent: 'europa', name: 'Torneos de clubes UEFA', iso: null, flagEmoji: '🏆' },
  { code: 'conmebol-clubs', continent: 'sudamerica', name: 'Torneos de clubes CONMEBOL', iso: null, flagEmoji: '🏆' },
  { code: 'concacaf-clubs', continent: 'norteamerica', name: 'Torneos de clubes CONCACAF', iso: null, flagEmoji: '🏆' },
  { code: 'caf-clubs', continent: 'africa', name: 'Torneos de clubes CAF', iso: null, flagEmoji: '🏆' },
  { code: 'afc-clubs', continent: 'asia', name: 'Torneos de clubes AFC', iso: null, flagEmoji: '🏆' },
];
...
export const COMPETITIONS = [
  ...
  // Colombia
  // sofaTournamentId/sofaSeasonId: ESPN casi nunca trae árbitro para esta liga,
  // así que se complementa con la designación de Sofascore (id de temporada
  // "Liga DIMAYOR 2026" verificado en julio de 2026; revisar cada año si cambia).
  { id: 'col-top', countryCode: 'col', tier: 'top', officialName: 'Categoría Primera A', espnSlug: 'col.1', sofaTournamentId: 11539, sofaSeasonId: 88503, available: true },
  ...
  // Torneos de clubes por confederación (fuera de las ligas domésticas).
  // Slugs verificados en vivo contra site.api.espn.com en julio de 2026.
  { id: 'uefa-champions', countryCode: 'uefa-clubs', tier: 'continental', officialName: 'UEFA Champions League', espnSlug: 'uefa.champions', available: true },
  { id: 'uefa-europa', countryCode: 'uefa-clubs', tier: 'continental', officialName: 'UEFA Europa League', espnSlug: 'uefa.europa', available: true },
  { id: 'conmebol-libertadores', countryCode: 'conmebol-clubs', tier: 'continental', officialName: 'Copa Libertadores', espnSlug: 'conmebol.libertadores', available: true },
  { id: 'conmebol-sudamericana', countryCode: 'conmebol-clubs', tier: 'continental', officialName: 'Copa Sudamericana', espnSlug: 'conmebol.sudamericana', available: true },
  { id: 'concacaf-champions', countryCode: 'concacaf-clubs', tier: 'continental', officialName: 'Concachampions', espnSlug: 'concacaf.champions', available: true },
  { id: 'caf-champions', countryCode: 'caf-clubs', tier: 'continental', officialName: 'CAF Champions League', espnSlug: 'caf.champions', available: true },
  { id: 'afc-champions', countryCode: 'afc-clubs', tier: 'continental', officialName: 'AFC Champions League Elite', espnSlug: 'afc.champions', available: true },
];

const TIER_LABEL = { top: 'Primera división', second: 'Segunda división', cup: 'Copa nacional', continental: 'Torneo internacional' };
...
export function buildCatalogTree() {
  return CONTINENTS.map((continent) => ({
    ...
    countries: COUNTRIES.filter((c) => c.continent === continent.id)
      // Los países-pseudo de torneos de confederación (iso: null) van primero;
      // el resto conserva el orden de declaración en COUNTRIES.
      .sort((a, b) => (a.iso === null ? 0 : 1) - (b.iso === null ? 0 : 1))
      .map((country) => ({
      code: country.code,
      name: country.name,
      iso: country.iso,
